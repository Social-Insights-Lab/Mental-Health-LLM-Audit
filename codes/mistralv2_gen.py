...
model = AutoModelForCausalLM.from_pretrained(model_id, torch_dtype="auto").to("cuda:1")
...
# ---- Output ----
out_path = "/home/ad2688/Research/mental_disorder/mistral-v0.2_generations.jsonl"
        ...
        for g in groups:
            for s in stereotypes:
                for idx, tpl in enumerate(templates):
                    ...
                    enc = tokenizer(prompt, return_tensors="pt").to("cuda:1")
                    out = model.generate(
                        **enc,
                        max_new_tokens=512,
                        do_sample=True,
